...
## Like the verbs with explicit time — 211

These formations showing the singular and the plural gender where the time is implied are not different from the morphemes of the personal class mentioned earlier⁶⁶.

## Non-personal class plural — 212
...
It is said that the interrogative `| evaṉ |` belongs to the two genders in that class.
...
These eight morphemes-one in the second person, one in the expressions of wish, another in the pre-modifier of a verbal phrase, another in the expression of
